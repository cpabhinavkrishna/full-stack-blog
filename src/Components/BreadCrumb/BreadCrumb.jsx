...
const BreadCrumb = () => {
  ...
  <nav className="flex flex-wrap items-center p-1 gap-0.5">
    <a
      href="#"
      className="inline-flex items-center gap-1.5 text-sm text-stone-800 transition-colors duration-300 ease-in hover:text-stone-200 rounded bg-stone-200 px-2 py-1 hover:bg-stone-700"
    >
      <svg
        width="1.5em"
        height="1.5em"
    ...
    <span className="inline-block mx-1 text-sm select-none pointer-events-none opacity-50 text-stone-800">
      <svg
        width="1.5em"
        height="1.5em"
        stroke-width="1.5"
    ...
    <a
      href="#"
      className="inline-flex items-center gap-1.5 text-sm text-stone-50 transition-colors duration-300 ease-in hover:text-stone-200 rounded bg-stone-800 px-2 py-1 hover:bg-stone-700"
    >
      <svg
        width="1.5em"
        height="1.5em"
